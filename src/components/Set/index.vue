<template>
  <div class="setting">
    <el-collapse class="collapse" v-model="activeName" accordion>
      <el-collapse-item title="壁纸设置" name="1">
        <div class="bg-set">
          <el-radio-group v-model="bgSet" text-color="#ffffff">
            <el-radio label="0" size="large" border>本地随机</el-radio>
            <el-radio label="1" size="large" border>必应每日</el-radio>
      ...
      <el-collapse-item title="关于" name="4">
        <div>Tips:鼠标中键以浏览壁纸。其他的,暂时没想到。</div>
      </el-collapse-item>
    </el-collapse>
  </div>
</template>
