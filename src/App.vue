...
|_____|_|  |_|_____/   |_|      |_|`;
  ...
  let styleTitle3 = "font-size: 15;font-weight: 600;color: rgb(244,167,89);";
  let styleTitle4 = "font-size:12px;color: rgb(244,167,89);";
  let title3 = "`API and other localized adaptations:Cl";
  let title4 = `
    ___________     ___
   /  _______ /    /  / 
  /  /            /  / 
...
/__________/    /__________/ `;
  ...
  console.info(
    `%c${title1} %c${title2} %c${content} %c${title3} %c${title4}`,
    styleTitle1,
    styleTitle2,
    styleTitle3,
    styleTitle4,
